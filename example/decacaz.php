...
class GhettoQueueCollector extends OauthPhirehose
{
   ...
   */
  const QUEUE_FILE_PREFIX = 'decacaz';
  const QUEUE_FILE_ACTIVE = '.decacaz.current';
   ...
   */
  public function __construct($username, $password, $queueDir = 'tmp', $rotateInterval = 60)
  {
...
define('OAUTH_TOKEN', '2388531318-zkj0bq4kll9kwBv6iexsiECTgQkotBTQvL7TmWJ');
define('OAUTH_SECRET', 'cDoi26lAxiAPb8pl5mWLkXYyQMEVdOd0f1UefTUVx16Bo');
