...
class GhettoQueueCollector extends OauthPhirehose
{
   ...
   */
  const QUEUE_FILE_PREFIX = 'limadigitid';
  const QUEUE_FILE_ACTIVE = '.limadigitid.current';
   ...
   */
  public function __construct($username, $password, $queueDir = 'limadigitid', $rotateInterval = 10)
  {
