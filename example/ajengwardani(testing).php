...
class GhettoQueueCollector extends OauthPhirehose
{
   ...
   */
  const QUEUE_FILE_PREFIX = 'ajengwardani';
  const QUEUE_FILE_ACTIVE = '.ajengwardani.current';
   ...
   */
  public function __construct($username, $password, $queueDir = 'ajengwardani', $rotateInterval = 10)
  {
    ...
    return parent::__construct($username, $password, Phirehose::METHOD_USER);
  }
...
define('OAUTH_TOKEN', '80004504-GfabsjpcjX8RNfoOUpk8pUi6RDhTXHWpdDzAm5SUJ');
define('OAUTH_SECRET', 'HVGMYu0OSYKlEewDo3a8upE3SjBjuBJ5hvSvPrrXW4sGO');

// Start streaming/collecting
$sc = new GhettoQueueCollector(OAUTH_TOKEN, OAUTH_SECRET);
// $sc->setTrack(array('@987genfm'));
$sc->consume();